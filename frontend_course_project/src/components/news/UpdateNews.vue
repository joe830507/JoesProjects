...
<template>
  <div class="grid">
    <div class="mb-10 ml-5 font-bold">最新消息管理/更新</div>
    <div class="w-80 grid">
      <label for="title">標題:</label>
      <input type="text" name="title" class="border-2 border-black w-96" v-model="item.topic" />
    </div>
    <div class="w-80 grid mt-10">
      <label for="content">內文:</label>
      <textarea name="content" class="border-2 border-black w-96 h-48" v-model="item.content" />
    </div>
